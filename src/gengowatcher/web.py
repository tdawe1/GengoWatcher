...
def attach_external_components(
    config: AppConfig, state: AppState, watcher: GengoWatcher, logger: logging.Logger
) -> None:
...
async def lifespan(app: FastAPI):
    ...
    try:
        ...
        api_instance = WebAPI(
            ...
            state,
            logger,
            watcher=_external_components["watcher"] if _external_components else None,
        )
