...
- PRs should describe the change, risks, and test evidence (`make test`, screenshots for UI). Link issues when available and call out config/env changes (e.g., new `config.ini` keys).
